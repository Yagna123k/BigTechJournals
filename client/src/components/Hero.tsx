        ...
        titleComponent={
          <>
            ...
            <p className="text-lg sm:text-xl text-slate-600 mb-8 max-w-2xl mx-auto leading-relaxed tracking-tight">
              Unite to <span className="font-bold text-slate-900">inspire</span>
              , <span className="font-bold text-slate-900">guide</span>, and{" "}
              <span className="font-bold text-slate-900">motivate</span>.
              <br />
              Read the real stories of those who made it.
            </p>
          </>
        }
      >
        <Image
          src={`https://images.unsplash.com/photo-1573164713714-d95e436ab8d6?ixlib=rb-4.0.3&auto=format&fit=crop&w=2400&q=80`}
          alt="hero"
          height={720}
          width={1400}
        ...
        <div className="absolute bottom-0 left-0 w-full p-10 bg-gradient-to-t from-black/90 via-black/50 to-transparent text-left">
          ...
          <h2 className="text-4xl text-white font-bold mb-2">
            How I cracked Morgan Stanley in 1st Year
          </h2>
          <p className="text-white/80 text-lg">Yagna Kusumanchi • SDE Intern</p>
        </div>
      </ContainerScroll>
